...
class CLMediaBase {
  ...
  @override
  String toString() {
    return 'CLMediaBase(name: $name, type: $type, fileSuffix: $fileSuffix, ref: $ref, originalDate: $originalDate, md5String: $md5String, isDeleted: $isDeleted, isHidden: $isHidden, pin: $pin, collectionId: $collectionId, isAux: $isAux)';
  }
