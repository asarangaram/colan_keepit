...
class CLMedia extends CLMediaBase implements CLEntity {
  ...
  factory CLMedia.fromMap(Map<String, dynamic> map) {
    return CLMedia.strict(
      ...
      fileSuffix: map['fileSuffix'] as String? ?? '.unk',
  ...
  CLMedia _copyWith({
    ...
    ValueGetter<String>? fileSuffix,
    ValueGetter<String?>? ref,
    ValueGetter<DateTime?>? originalDate,
    ValueGetter<DateTime?>? addedDate,
    ...
    return CLMedia.strict(
      ...
      fileSuffix: fileSuffix != null ? fileSuffix() : this.fileSuffix,
      ...
      addedDate: addedDate != null ? addedDate() : this.addedDate,
  ...
  /// if  addedDate is missing (is null), it will be updated with updatedDate
  ///
  ...
  @override
  DateTime get entityCreatedDate => addedDate;
