...
class Collection implements CLEntity {
  ...
  @override
  String toString() {
    return 'Collection(label: $label, description: $description, addedDate: $addedDate, updatedDate: $updatedDate, id: $id, haveItOffline: $haveItOffline, serverUID: $serverUID, isDeleted: $isDeleted, isEdited: $isEdited)';
  }
